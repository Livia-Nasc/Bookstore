...
CREATE TABLE `livros_categorias` (
  ...
  CONSTRAINT `livros_categorias_ibfk_1` FOREIGN KEY (`id_livros`) REFERENCES `livros` (`id_livros`),
  CONSTRAINT `livros_categorias_ibfk_2` FOREIGN KEY (`id_categorias`) REFERENCES `categorias` (`id_categorias`)
